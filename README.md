...
Exploratory Data Analysis (EDA) – Understanding distributions and trends
Feature Analysis – Category-wise and product-level insights
SQL Analysis – Using window functions (ROW_NUMBER, RANK) for ranking and segmentation
Insight Generation – Translating data findings into business insights
